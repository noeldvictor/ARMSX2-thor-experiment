...
extern "C"
JNIEXPORT jstring JNICALL
Java_kr_co_iefriends_pcsx2_NativeApp_getTextureUpscaleStats(JNIEnv *env, jclass clazz) {
    ...
    const std::string json = fmt::format(
        ...
        "\"discAtlasPaletteFreeMatches\":{},\"discAtlasTrueColourMatches\":{},\"discAtlasCompositeMatches\":{}}}",
        ...
        GSDiscAtlas::IsLoaded(), da.images, da.matches, da.misses, da.palette_free_matches, da.true_colour_matches, da.composite_matches);
    return env->NewStringUTF(json.c_str());
}
