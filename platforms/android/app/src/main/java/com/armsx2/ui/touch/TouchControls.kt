...
object TouchControls {
     ...
     *  (upstream's default); 12 = Always, never hidden by anything but the
    ...
    private fun load() {
        ...
        visibilityMode.intValue = MainActivityRuntime.prefs.getInt(KEY_VIS_MODE, 0).coerceIn(0, VISIBILITY_ALWAYS)
