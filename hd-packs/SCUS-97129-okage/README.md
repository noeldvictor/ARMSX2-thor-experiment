...
| build | 1.9 min | `pack_hd4x/replacements/`: 310 MB - 2,797 ASTC images (zstd), 3 palette-free PNGs, a 38.1 MB index; 5 duplicate and 7 blank disc images left out (rebuilt 2026-09-25: ASTC with repaired alpha blocks, zstd) |
| zip | 14 s | `SCUS-97129-disc-hd4x.zip`, 294 MB |
| **total** | **about 16 min** | |
...
| Index `disc-atlas.a2at` SHA-256 (ASTC + zstd pack) | `cc22145f86ccb0a01119c9bb4bacd0270ddfa354bf002a8ebc190408a335b538` |
