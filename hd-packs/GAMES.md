...
| [<img src="SLUS-21275-river-king/media/house.jpg" width="220" alt="River King house, original vs HD pack">](SLUS-21275-river-king/README.md) | [River King: A Wonderful Journey](SLUS-21275-river-king/README.md)<br>SLUS-21275, NTSC-U | **In progress** | 2.4 GB zip<br>2.7 GB installed | ~43 min | Every texture of the five opening scenes (title, menus, name entry, dialogue, the house), text included; 59.5 fps at 3x in the app. Fishing, river and town not tested yet. |
| [<img src="SLUS-21201-tales-of-legendia/media/portraits.jpg" width="220" alt="Tales of Legendia portrait conversation, original vs HD pack">](SLUS-21201-tales-of-legendia/README.md) | [Tales of Legendia](SLUS-21201-tales-of-legendia/README.md)<br>SLUS-21201, NTSC-U (ReUndub v1.4) | **In progress** | 7.8 GB zip<br>11 GB installed | ~2 h 50 min (not a clean run) | Maps, models, skit portraits, the dialogue font and the title: four scenes on the Thor, everything matched but render-target reads and two small UI pieces; 59.9 fps at 3x. Towns and battles not tested yet. |
| - | [Tales of Rebirth](SLPS-25450-tales-of-rebirth/README.md)<br>SLPS-25450, English patch v1.0 | **In progress** (no pack yet) | about 23 GB at 4x (estimate) | ~6 h upscale (estimate) | Recipe done and a 1x pack proven exact on the Thor in four scenes (title, battle, two fields). The map sheets carry ~3 palettes each: 39 GB as a plain 4x pack, ~23 GB with the sheets split per palette. Which cut to build is open. |
