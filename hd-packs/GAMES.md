...
| [<img src="SLPS-25450-tales-of-rebirth/media/field.jpg" width="220" alt="Tales of Rebirth field, original vs HD pack">](SLPS-25450-tales-of-rebirth/README.md) | [Tales of Rebirth](SLPS-25450-tales-of-rebirth/README.md)<br>SLPS-25450, English patch v1.0 | **In progress** | 23.9 GB zip<br>24.8 GB installed (PNG) | ~9 h 35 min | Map sheets (split per palette), sprites, UI and the font: four scenes on the Thor, every composite loads; 59.9 fps at 3x. Translucent ice gets harder edges; runtime palettes stay native. Too big to keep on the Thor. |
